...
EXPECTED_HOLDER_NAMES = [
    ...
    "The Ukcoin Core developers\n",
    "The Ukcoin Core developers \n",
    "Ukcoin Core Developers\n",
    "the Ukcoin Core developers\n",
    "The Ukcoin developers\n",
    "BitPay Inc\.\n",
    "BitPay, Inc\.\n",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Ukcoin Core developers'
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Ukcoin 
