...
By default, ukcoind will dump mempool on shutdown and
...
class MempoolPersistTest(UkcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give ukcoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent ukcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
