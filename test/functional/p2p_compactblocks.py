...
# TestNode: A peer we use to send messages to ukcoind, and store responses.
...
class CompactBlocksTest(UkcoinTestFramework):
    ...
    # This test actually causes ukcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that ukcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for ukcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # ukcoind will not send blocktxn responses for blocks whose height is
