...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the UkcoinTestFramework
    pass

class ExampleTest(UkcoinTestFramework):
    # Each functional test is a subclass of the UkcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        UkcoinTestFramework class so other tests can use it."""
