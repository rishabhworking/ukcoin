...
class WalletTest(UkcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 UKC from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 UKC with subtract fee from amount
        ...
        # Sendmany 10 UKC with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/Lucky1689/ukcoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
