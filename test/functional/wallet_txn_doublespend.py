...
class TxnMallTest(UkcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 UKC:
        ...
        # First: use raw transaction API to send 1240 UKC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 UKC coin each
        ...
        # Node0's balance should be starting balance, plus 50UKC for another
        ...
        # Node0's total balance should be starting balance, plus 100UKC for 
