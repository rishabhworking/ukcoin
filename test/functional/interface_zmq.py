...
from test_framework.test_framework import UkcoinTestFramework, SkipTest
...
class ZMQTest (UkcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that ukcoin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("ukcoind has not been built with zmq enabled.")
