...
class BIP66Test(UkcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # ukcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and ukcoind produces more specific reject
            # reasons.
