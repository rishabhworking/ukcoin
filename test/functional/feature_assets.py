...
class AssetTest(UkcoinTestFramework):
    ...
    def activate_assets(self):
        self.log.info("Generating UKC for node[0] and activating assets...")
    ...
    def big_test(self):
        ...
        n0.listassets(asset="UKC*", verbose=False, count=2, start=-2)
        ...
        ukcoin_assets = n0.listassets(asset="UKC*", verbose=False, count=2, start=-2)
        assert_equal(len(ukcoin_assets), 2)
        assert_equal(ukcoin_assets[0], "UKC2")
        assert_equal(ukcoin_assets[1], "UKC3")
        self.sync_all()
