...
class TestUkcoinCli(UkcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `ukcoin-cli getinfo`")
        ...
        self.log.info("Compare responses from `ukcoin-cli -getinfo` and the RPCs data is retrieved from.")
