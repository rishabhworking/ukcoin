...
#ifndef UKC_TEST_SCRIPTNUM10_H
#define UKC_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Ukcoin Core 0.10.0, for cross-comparison.
 */
public:
