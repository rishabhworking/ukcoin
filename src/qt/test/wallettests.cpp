...
#include "qt/ukcoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<UkcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_ukcoin-qt -platform xcb      # Linux
//     src/qt/test/test_ukcoin-qt -platform windows  # Windows
//     src/qt/test/test_ukcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = UkcoinUnits::formatWithUnit(unit, balance, false, UkcoinUnits::separatorAlways);
    ...
    // Amount input
    UkcoinAmountField* amountInput = receiveCoinsDialog.findChild<UkcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: ukcoin:")) != -1);
