...
#ifndef UKC_QT_GUICONSTANTS_H
#define UKC_QT_GUICONSTANTS_H
...
/* UkcoinGUI -- Size of icons in status bar */
...
/* Color of labels */
#define COLOR_LABELS QColor("#020303")
...
/* Ukcoin dark blue */
#define COLOR_DARK_BLUE QColor("#020303")
/* Ukcoin light blue */
#define COLOR_LIGHT_BLUE QColor("#fe940d")
/* Ukcoin asset text */
#define COLOR_ASSET_TEXT QColor(255, 255, 255)
/* Ukcoin shadow color - light mode */
#define COLOR_SHADOW_LIGHT QColor("#ffffff")
/* Toolbar not selected text color */
#define COLOR_TOOLBAR_NOT_SELECTED_TEXT QColor("#020303")
...
/* Ukcoin label color as a string */
#define STRING_LABEL_COLOR "color: #020303"
...
#define QAPP_ORG_NAME "Ukcoin"
#define QAPP_ORG_DOMAIN "ukcoin.org"
#define QAPP_APP_NAME_DEFAULT "Ukcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Ukcoin-Qt-testnet"

#endif // UKC_QT_GUICONSTANTS_H
