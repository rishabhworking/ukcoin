...
#ifndef UKC_QT_UKCGUI_H
#define UKC_QT_UKCGUI_H
...
/**
  Ukcoin GUI main class. This class represents the main window of the Ukcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class UkcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit UkcoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~UkcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a ukcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
