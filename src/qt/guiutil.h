...
#ifndef UKC_QT_GUIUTIL_H
#define UKC_QT_GUIUTIL_H
...
/** Utility functions used by the Ukcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "ukcoin:" URI into recipient object, return true on successful parsing
