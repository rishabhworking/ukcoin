...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(UkcoinUnits::UKC),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(UkcoinUnits::formatWithUnit(unit, balance, false, UkcoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(UkcoinUnits::formatWithUnit(unit, unconfirmedBalance, false, UkcoinUnits::separatorAlways));
    ui->labelImmature->setText(UkcoinUnits::formatWithUnit(unit, immatureBalance, false, UkcoinUnits::separatorAlways));
    ui->labelTotal->setText(UkcoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, UkcoinUnits::separatorAlways));
    ui->labelWatchAvailable->setText(UkcoinUnits::formatWithUnit(unit, watchOnlyBalance, false, UkcoinUnits::separatorAlways));
    ui->labelWatchPending->setText(UkcoinUnits::formatWithUnit(unit, watchUnconfBalance, false, UkcoinUnits::separatorAlways));
    ui->labelWatchImmature->setText(UkcoinUnits::formatWithUnit(unit, watchImmatureBalance, false, UkcoinUnits::separatorAlways));
    ui->labelWatchTotal->setText(UkcoinUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, UkcoinUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("UKC")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the UKC balance grid from expanding and looking terrible when asset balance is hidden
