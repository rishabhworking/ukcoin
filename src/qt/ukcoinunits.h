...
#ifndef UKC_QT_UKCUNITS_H
#define UKC_QT_UKCUNITS_H
...
/** Ukcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class UkcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit UkcoinUnits(QObject *parent);

    /** Ukcoin units.
      @note Source: https://en.ukcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        UKC,
...
typedef UkcoinUnits::Unit UkcoinUnit;

#endif // UKC_QT_UKCUNITS_H
