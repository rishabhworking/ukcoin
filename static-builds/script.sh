...
find ${DISTNAME}/bin -type f -executable -exec ../ukcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../ukcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/ukcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/ukcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
