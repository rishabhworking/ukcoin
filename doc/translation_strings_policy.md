...
This document provides guidelines for internationalization of the Ukcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ukcoin_en.ts` remains unchanged.
